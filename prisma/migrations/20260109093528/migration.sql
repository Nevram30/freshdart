-- CreateEnum
CREATE TYPE "StockType" AS ENUM ('WEIGHT', 'UNIT');

-- CreateEnum
CREATE TYPE "ProductStatus" AS ENUM ('ACTIVE', 'OUT_OF_STOCK', 'DISCONTINUED');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'CONFIRMED', 'PROCESSING', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED', 'REFUNDED');
...
-- CreateIndex
CREATE INDEX "Product_bestBefore_idx" ON "Product"("bestBefore");
