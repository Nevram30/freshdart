...
const documentStatusConfig: Record<
  string,
  { label: string; variant: "success" | "warning" | "danger" | "info"; icon: typeof CheckCircle }
> = {
...
export default function MerchantProfilePage() {
  ...
  const verificationConfig =
    verificationStatusConfig[verificationStatus] ?? verificationStatusConfig.PENDING!;
        ...
        >
          ...
          <div className="flex-1">
            <p className="font-medium">
              {verificationConfig?.label ?? "Pending Verification"}
            </p>
            {verificationStatus === "PENDING" && (
          ...
          {profile.merchant.isFeatured && (
            <div className="flex items-center gap-1 rounded-full bg-blue-100 px-3 py-1 text-blue-700">
              ...
              <span className="text-sm font-medium">Featured Merchant</span>
            </div>
          )}
        </div>
      )}
        ...
        <div className="rounded-xl border border-gray-200 bg-white">
          ...
          <div className="divide-y divide-gray-100">
            {profile.merchant.documents.map((doc) => {
              const statusConfig =
                documentStatusConfig[doc.status] ?? documentStatusConfig.PENDING!;
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <Badge
                      variant={
                        isExpired ? "danger" : (statusConfig?.variant ?? "warning")
                      }
                    >
